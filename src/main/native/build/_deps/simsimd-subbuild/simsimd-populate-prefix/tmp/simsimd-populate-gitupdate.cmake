...
execute_process(
  COMMAND "/usr/sbin/git" --git-dir=.git show-ref "main"
  WORKING_DIRECTORY "/home/ashesha/Sources/vector-index/src/main/native/build/_deps/simsimd-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ashesha/Sources/vector-index/src/main/native/build/_deps/simsimd-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ashesha/Sources/vector-index/src/main/native/build/_deps/simsimd-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
